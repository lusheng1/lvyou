...
<head>
<title>绿友网</title>
<meta name="description" content="绿友登陆" />
<meta charset="utf-8">
...
var validator = $("#signupForm").validate({meta: "validate"}); 	  // 点击“保存”按钮时先验证，验证通过后方能保存	  
    ...
    <div class="container">
      ...
      <form id="signupForm" method="POST" action="<?php echo U('Home/Login/oper');?>"  >
      <div class="reg-form" id="js-form-mail">
        ...
        <!-- <div class="cell vcode">
          ...
          <input type="text" name="code" id="vcode" class="text" maxlength="4" />
        ...
        <div class="bottom"> <a id="submit"  class="button btn-green" >立即登陆</a> </div>
      </div>
	  </form>
    </div>
  </div>
