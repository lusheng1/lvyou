	...
	<div id="center-home" class="con-in">
		...
		<div class="side-cha b-side-cha">
			...
			<div class="box-info info-box">
				<span class="avatar"><a target="_blank" title="" href=""><img alt="" src="" id="portrait" style="display: inline;"></a></span>
				<div class="txt">
					<p class="t1"><span class="hello js-hello">中午好！</span>亲爱的：</p>
					<div class="b-side-pn">
						<span data-clip="12" class="nickname" ><?php echo session('username');?></span>
											</div>
					
				</div>
				<span class="clearfix"></span>
				<div class="b-side-pn account">
					<span class="t1">帐 号：</span>
					<span class="c1">
						<span data-clip="20" ><?php echo session('userid');?></span>
											</span>
				</div>
                				<div class="b-side-pn b-location">
					<span class="t1">上次登录：</span>
					<span class="c1">
						<a class="more linkcolor fr" title="更多" href="/thinkphp/index.php/Home/User/user">更多 »</a>
						<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><table>
						  <tr>
							<td width="200px" height="50px" bgcolor=""style="text-align:center;">上次登录时间<a> <font class="black"><?php echo ($vo["logintime"]); ?></font></a></td>
							  <td width="200px" height="50px" bgcolor=""style="text-align:center;">上次登录地点<a> <font class="black"><?php echo ($vo["country"]); ?></font></a></td>
						</tr>
